...
ALLOWED_TRANSITIONS: dict[TripState, set[TripState]] = {
    ...
    TripState.paused: {TripState.active_trip, TripState.cancelled},
    TripState.off_route: {TripState.replanning, TripState.active_trip, TripState.cancelled},
    TripState.at_risk: {TripState.replanning, TripState.active_trip, TripState.cancelled},
    TripState.replanning: {TripState.active_trip, TripState.at_risk, TripState.cancelled},
